...
from ..inventor.forms import ProjectForm, CategoryForm, ResearchForm, ProjtitleForm
from .. import db
from ..models import Project, Category, Research, Projtitle, Finproj, Doproj
from app import images, audio, documents
...
def add_research():
    ...
    form = ResearchForm()
    if form.validate_on_submit():
    	fil = documents.save(request.files['research_file'])
